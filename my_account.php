          ...
          document.getElementById("mySidenav").style.width = "0";
            ...
            <a href="#">
                <div class="tabs" style="width:calc(90%-10px);height:60px; padding: 5px;margin:3% 5%;border:thin solid blue;">
                    ...
                    <h2 style="float:left;white-space: nowrap;width:75%;">Last reported Case</h2>
                    
                </div>
            </a>
            <div style="width:calc(90%-10px);height:150px; padding: 5px;margin:3% 5%;border:thin solid blue;">
